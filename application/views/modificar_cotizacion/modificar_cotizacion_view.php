...
<html lang="en">
	<head>
		...
		<script>
			...
			var id_cotizacion_temporal = "<?=$this->session->usuario['id_cotizacion_temporal_modificar']?>";
		</script>
	</head>
	<body>
		...
		<div class="wrapper d-flex align-items-stretch">
			...
			<div id="content" class="main">
				...
				<div id="contenido" class="container-fluid mb-4">
					...
					<div class="row mb-2">
						<div class="col-12">
							<div class="alert alert-dismissible fade show mb-0 alert-info d-none" role="alert" id="alerta_cotizacion_guardada">
								<strong>Estás modificando una cotización existente generada en <span id="fecha_cotizacion_guardada"></span>: </strong><a class="descartar-modificaciones" href>¿Deseas descartar los cambios y volver a la lista de cotizaciones?</a>
					...
					<div class="tab-content" id="nav-tabContent">
						<div class="tab-pane fade show active" id="vista_cliente" role="tabpanel" aria-labelledby="nav_vista_cliente">
							<div class="form-row mt-2">
								<div class="col-sm-1 col-3 form-group">
									<label for="folio_cotizacion">Folio</label>
									<input class="form-control" type="text" id="folio_cotizacion" name="folio_cotizacion" value="<?=$this->session->usuario['id_cotizacion_temporal']?>" disabled>
								</div>
							...
							<div class="form-row">
								...
								<div class="col-sm-4 col-12 form-group">
									...
									<div class="input-group">
										...
										<input id="consumo_promedio_pesos" name="consumo_promedio_pesos" type="number" class="form-control" readonly>
									</div>
								</div>
								<div class="col-sm-4 col-12 form-group align-self-end">
									<button type="button" class="btn btn-block btn-success" id="calcular_consumos">Calcular consumos</button>
								</div>
							</div>
							<div class="row mt-2">
								<div class="col-12">
							...
							<div class="form-row" id="datos_estructura">
								...
								<div class="col-sm-2 col-6 form-group">
									...
									<input class="form-control cantidad_estructura" type="number" id="cantidad_estructura" name="cantidad_estructura" value="1" min="1" max="999" disabled>
								</div>
								<div class="col-sm-2 col-6 form-group align-self-end">
									<button class="btn btn-success btn-block" id="agregar_estructura" disabled>Agregar</button>
								</div>
							</div>
							<div class="form-row">
							...
							<div class="row mt-2">
								...
								<div class="col-12 col-sm-3">
									<button class="btn btn-success btn-block" type="button" data-toggle="modal" data-target="#modal_agregar_producto">Añadir otro producto</button>
								</div>
							</div>
							...
							<div class="row" id="row_roi">
								<div class="col-12">
									<div class="chart-container" id="contenedor_roi" style="position: relative; height:400px; width:90%; margin:auto">
									...
									<div class="form-row">
										<div class="col-6 form-group">
											...
											<div class="input-group">
												...
												<input id="admin_tasa_cambio" name="admin_tasa_cambio" type="number" class="form-control" min="0.01" step="0.01" readonly>
												<div class="input-group-append">
													<button class="btn btn-primary" type="button" id="cambiar_tasa_usd">Cambiar</button>
												</div>
											</div>
										</div>
							...
							<div class="form-row">
								<div class="col-lg-3 col-6 form-group">
									...
									<div class="input-group">
										...
										<input id="admin_costo_por_metro" name="admin_costo_por_metro" type="text" class="form-control" readonly>
									</div>
								</div>
								<div class="col-lg-3 col-6 form-group">
									...
									<div class="input-group">
										...
										<input id="admin_costo_tuberia" name="admin_costo_tuberia" type="text" class="form-control" value="0.00" readonly>
									</div>
								</div>
								<div class="col-lg-3 col-6 form-group">
							...
							<div class="form-row">
								...
								<div class="col-sm-3 col-6 form-group">
									...
									<div class="input-group">
										...
										<input id="admin_suministro" name="admin_suministro" type="text" class="form-control" readonly>
									</div>
								</div>
								<div class="col-sm-3 col-6 form-group">
									...
									<div class="input-group">
										...
										<input id="admin_gasto_bimestral" name="admin_gasto_bimestral" type="text" class="form-control" readonly>
									</div>
								</div>
								<div class="col-sm-3 col-6 form-group">
									...
									<div class="input-group">
										...
										<input id="admin_gasto_anual" name="admin_gasto_anual" type="text" class="form-control" readonly>
									</div>
								</div>
							</div>
							<div class="row mt-2">
					...
					<div class="form-row mt-4">
						<div class="col-sm-6 form-group">
							<button class="btn btn-success btn-block" id="generar_cotizacion">Guardar cotización</button>
						</div>
						<div class="col-sm-6 form-group">
							<button class="btn btn-danger btn-block descartar-modificaciones" type="button">Descartar cambios</button>
						</div>
					</div>
				</div>
			</div>
		</div>
		<div class="modal fade" id="modal_agregar_producto" tabindex="-1" role="dialog" aria-labelledby="modal_agregar_producto_label" aria-hidden="true">
												...
												<form id="nuevo_extra" name="nuevo_extra" method="post">
													<div class="form-row">
														<div class="col-sm-4 col-6 form-group">
															...
															<input id="extra_codigo" name="codigo" type="text" class="form-control" required>
														</div>
														<div class="col-sm-4 col-6 form-group">
															<label for="extra_producto">Producto</label>
															<input id="extra_producto" name="producto" type="text" class="form-control" required>
														</div>
														<div class="col-sm-4 col-6 form-group">
															<label for="extra_marca">Marca</label>
															<input id="extra_marca" name="marca" type="text" class="form-control" required>
														</div>
														<div class="col-sm-4 col-6 form-group">
														...
														<div class="col-sm-4 col-6 form-group">
															<label for="extra_moneda">Moneda</label>
																<select id="extra_moneda" class="form-control" name="moneda" required>
														...
														<div class="col-sm-4 col-12 form-group align-self-end">
															<button type="submit" class="btn btn-success btn-block">Agregar extra</button>
														</div>
													</div>
												</form>
											</div>
		...
		<script src="<?= base_url() ?>static/js/modificar_cotizacion/modificar_cotizacion.js"></script>
	</body>
</html>