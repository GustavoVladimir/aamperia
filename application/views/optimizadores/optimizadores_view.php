	...
	<body>
			...
			<div id="content" class="main">
				...
				<div id="contenido" class="container-fluid">
					<div class="botones_crud mt-4">
						<div class="row">
							<div class="col-sm-6">
								<h2>Gestión de optimizadores</h2>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-6 col-12 d-flex justify-content-center align-items-end">
								<button class="btn btn-success btn-block" type="button" data-toggle="modal" data-target="#agregar">Agregar nuevo optimizador</button>
							</div>
						</div>
					</div>
					<div class="row mt-4">
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">Agregar optimizador</h5>
		...
		<div class="modal fade" id="editar" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">Editar optimizador</h5>
						<button type="button" class="close" data-dismiss="modal">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
						...
						<form method="post" id="formulario_editar">
							<div class="form-row">
								<div class="col-sm-2 col-2 form-group">
									...
									<input class="form-control" type="text" id="id_editar" name="id_optimizador" readonly>
								</div>
								<div class="col-sm-6 col-7 form-group">
									<label for="codigo_editar">Código</label>
									<input class="form-control" type="text" id="codigo_editar" name="codigo" required>
								</div>
								<div class="col-sm-4 col-3 form-group">
		...
		<div class="modal fade" id="ver" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">Ver optimizador</h5>
						<button type="button" class="close" data-dismiss="modal">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
		...
		<script src="<?= base_url() ?>/static/js/optimizadores/optimizadores.js"></script>
	</body>
</html>